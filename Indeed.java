...
public class Indeed {
  ...
  //3
  public Indeed(String userName,int password) {
	  this();
  ...
  //4
  public Indeed(String userName,int password,String email,long contactNumber) {
  ...
  //5
  public Indeed(String userName,int password,String email,long contactNumber,String address) {
	  System.out.println("this is parametrized constructor with 5 args");
	  this.userName=userName;
	  this.password=password;
	  this.email=email;
	  this.contactNumber=contactNumber;
	  this.address=address;  System.out.println("userName:"+userName+""+"password:"+password+""+"email:"+email+""+"contactNumber:"+contactNumber+""+"address:"+address);
  }
  
  //6
  public Indeed(String userName,int password,String email,long contactNumber,String address,Date accountCreateDate) {
  ...
  //7
  public Indeed(String userName,int password,String email,long contactNumber,String address,Date accountCreateDate,String gender) {
